...
class ROIHeads(torch.nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        self.gamma = cfg.MODEL.ROI_HEADS.GAMMA # 2.0
        bg_weight = cfg.MODEL.ROI_HEADS.BG_WEIGHT # 0.2
        self.weight = torch.ones(cfg.MODEL.ROI_HEADS.NUM_CLASSES + 1).cuda()
        self.weight[-1] = bg_weight
        self.bnrl_hyper = (self.weight, self.alpha,self.beta,self.epsilon,self.gamma )
        # fmt: on
...
class Res5ROIHeads(ROIHeads):
    ...
    def forward(self, images, features, proposals, targets=None, image_id=None):
        """
        ...
        outputs = FastRCNNOutputs(
            ...
            proposals,
            self.smooth_l1_beta, self.losstype, self.bnrl_hyper
        )
        ...
        if self.training:
            ...
            pred_instances, filter_ind = outputs.inference(
