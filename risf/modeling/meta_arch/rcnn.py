...
from risf.modeling.backbone import build_backbone
from detectron2.modeling.postprocessing import detector_postprocess
from detectron2.modeling.proposal_generator import build_proposal_generator
from .build import META_ARCH_REGISTRY
from .gdl import decouple_layer, AffineLayer
from risf.modeling.roi_heads import build_roi_heads
...
class GeneralizedRCNN(nn.Module):
    ...
    def _forward_once_(self, batched_inputs, gt_instances=None):
        ...
        results, detector_losses = self.roi_heads(images, features_de_rcnn, proposals, gt_instances, batched_inputs[0]['image_id'])
